 ...
 *
 * @package report
 * @subpackage globalassign
 * @author Joby Harding / David Scotson / Stuart Lamour / Guy Thomas (vue files and core Moodle grunt loader)
...
module.exports = function(grunt) {
    ...
    require(${configfile});
    $vueCompDir = "$CFG->dirroot/admin/tool/behatdump/vue/comps";
